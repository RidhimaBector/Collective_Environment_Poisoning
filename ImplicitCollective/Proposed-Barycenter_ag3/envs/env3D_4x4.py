...
class GridWorld_3D_env(Env):
    ...
    def _calculate_transition_status(self, cur_s, action, T):
        ...
        is_done = next_s == 15 #is_done = tuple(next_position)==(3,3) #Change_Target_Behavior #E-(3,2), M-(3,3), Mp-(3,0), H-(3,0)
    ...
    def __init__(self):
        ...
        # target state
        #self.goal_s = 15 # Victim Goal State               #self.target_s = 15 #np.ravel_multi_index((3,3), self.shape) #Change_Target_Behavior #E-(3,2), M-(3,3), Mp-(3,0), H-(3,0)
